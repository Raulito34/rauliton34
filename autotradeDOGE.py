...
def fetch_and_prepare_data():
    ...
    df_hourly = pyupbit.get_ohlcv("KRW-DOGE", interval="minute5", count=24)
...
if __name__ == "__main__":
    ...
    schedule.every(5).minutes.do(make_decision_and_execute)
