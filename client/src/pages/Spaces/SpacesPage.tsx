...
const spaces = [
  {
    floor: '1f', label: '1F', name: '1전시관', area: 120, pyeong: 35, height: 5.0, capacity: 80,
  ...
  {
    floor: '2f', label: '2F', name: '2전시관', area: 250, pyeong: 75, height: 3.5, capacity: 60,
  ...
  {
    floor: '3f', label: '3F', name: '3전시관', area: 250, pyeong: 75, height: 3.2, capacity: 50,
  ...
  {
    floor: '4f', label: '4F', name: '4전시관', area: 70, pyeong: 20, height: 6.0, capacity: 150,
    desc: '세미나, 공연, 특별전시가 가능한 다목적 공간으로, 가변형 무대와 조명 시스템을 갖추고 있습니다.',
    imageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800',
    features: ['가변형 무대', '프로젝터/스크린', '무선 마이크', '150석 좌석'],
  },
  {
    floor: 'b1f', label: 'B1F', name: 'B1전시관', area: 250, pyeong: 75, height: 4.5, capacity: 100,
