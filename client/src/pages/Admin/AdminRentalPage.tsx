      ...
      <div>
        <section className="bg-primary text-white py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-2">대관 관리</h1>
            <p className="text-gray-400 text-sm">Admin - Rental Management</p>
          </div>
        </section>
        <section className="py-20 bg-white">
          <div className="max-w-sm mx-auto text-center">
            ...
            <p className="text-gray-500 text-sm mb-8">관리자 코드를 입력해주세요.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between mb-4">
            <Link to="/admin/homepage" className="text-xs text-accent hover:text-accent-light border border-accent/40 px-3 py-1.5 rounded transition-colors">
              홈페이지 관리
            </Link>
            <button
