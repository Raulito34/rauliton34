...
const spaces = [
  { key: '1F 제1전시관', floor: '1F', name: '제1전시관', area: '180㎡' },
  { key: '2F 제2전시관', floor: '2F', name: '제2전시관', area: '160㎡' },
  { key: '3F 제3전시관', floor: '3F', name: '제3전시관', area: '150㎡' },
  { key: '4F 제4전시관', floor: '4F', name: '제4전시관', area: '200㎡' },
  { key: 'B1F 제5전시관', floor: 'B1F', name: '제5전시관', area: '200㎡' },
];

const floorPlans: Record<string, string[]> = {
  '1F 제1전시관': ['면적: 180㎡', '층고: 5.0m', '수용: 80명', '남향 자연광, 이동식 가벽 12패널'],
  '2F 제2전시관': ['면적: 160㎡', '층고: 3.5m', '수용: 60명', '자유 가벽 배치, 스팟/월워셔 조명'],
  '3F 제3전시관': ['면적: 150㎡', '층고: 3.2m', '수용: 50명', '정밀 디밍 조명, 유리 진열장 8대'],
  '4F 제4전시관': ['면적: 200㎡', '층고: 6.0m', '수용: 150명', '가변형 무대, 4K 프로젝터'],
  'B1F 제5전시관': ['면적: 200㎡', '층고: 4.5m', '수용: 100명', '암실 구현 가능, 대형 프로젝션 4면'],
};
