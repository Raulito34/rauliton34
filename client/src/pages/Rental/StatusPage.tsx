...
const spaces = [
  { key: '1F 1전시관', floor: '1F', name: '1전시관', area: '115.5㎡ (35평)' },
  { key: '2F 2전시관', floor: '2F', name: '2전시관', area: '247.5㎡ (75평)' },
  { key: '3F 3전시관', floor: '3F', name: '3전시관', area: '247.5㎡ (75평)' },
  { key: '4F 4전시관', floor: '4F', name: '4전시관', area: '66㎡ (20평)' },
  { key: 'B1F B1전시관', floor: 'B1F', name: 'B1전시관', area: '247.5㎡ (75평)' },
];

const floorPlans: Record<string, string[]> = {
  '1F 1전시관': ['면적: 115.5㎡ (35평)', '층고: 5.0m', '수용: 80명', '남향 자연광, 이동식 가벽 12패널'],
  '2F 2전시관': ['면적: 247.5㎡ (75평)', '층고: 3.5m', '수용: 60명', '자유 가벽 배치, 스팟/월워셔 조명'],
  '3F 3전시관': ['면적: 247.5㎡ (75평)', '층고: 3.2m', '수용: 50명', '정밀 디밍 조명, 유리 진열장 8대'],
  '4F 4전시관': ['면적: 66㎡ (20평)', '층고: 6.0m', '수용: 150명', '가변형 무대, 4K 프로젝터'],
  'B1F B1전시관': ['면적: 247.5㎡ (75평)', '층고: 4.5m', '수용: 100명', '암실 구현 가능, 대형 프로젝션 4면'],
};
